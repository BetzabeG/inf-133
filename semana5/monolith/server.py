...
class BlogHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        #Generar la respuesta json de acuerdo a la solitud
        if self.path == "/posts":
            ...
            if post:
                ...
                self.send_error(404, "Publicacion no encontrada")
        else:
            self.send_error(404, "Ruta no valida")
    ...
    def do_PUT(self):
        ...
        if self.path.startswith("/post/"):
            ...
            self.send_error(404, "Ruta no vaida")
